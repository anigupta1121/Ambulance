package com.ambulance.module_doctor_chat;
...
import com.ambulance.DBHandler;
import com.ambulance.R;
import com.ambulance.ChatActivity;
...
public class ChatFrag extends Fragment {
    ...
    private void setFriend(String pushFriend, String userName) {
        ...
        progressDialog.dismiss();
        ((ChatActivity) getContext()).getSupportFragmentManager()
                .beginTransaction()
